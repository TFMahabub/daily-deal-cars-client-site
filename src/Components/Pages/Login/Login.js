  ...
  return (
    <section className="lg:h-[90vh] mt-14 lg:mt-0 px-2 lg:px-0 lg:flex lg:justify-center lg:items-center">
      <div className="border-2 border-secondary rounded-lg p-4">
        <h2 className="text-2xl font-semibold text-secondary text-center mb-5">Log in</h2>



        <form onSubmit={handleOnSubmit} action="" className="">
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-400">
          ...
          <Link
            to='/register'
            className="underline text-secondary ml-1"
          >
             Register
          </Link>
        </p>
